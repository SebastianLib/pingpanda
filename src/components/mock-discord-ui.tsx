...
export default function MockDiscordUI({ children }: PropsWithChildren) {
  return (
    <div
      className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background
    text-white round-lg overflow-hidden shadow-xl"
    >
      <div
        className="hidden sm:flex w-[72px] bg-[#202225]
        py-3 flex-col items-center"
      >
        <div
          className="size-12 bg-discord-brand-color rounded-2xl flex
            items-center justify-center mb-2 hover:rounded-xl transition-all
            duration-200"
        >
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="size-12 bg-discord-background rounded-3xl flex
                items-center justify-center mb-3 hover:rounded-xl transition-all 
                duration-200 hover:bg-discord-brand-color cursor-not-allowed"
          >
        ...
        <div
          className="group mt-auto size-12 bg-discord-background rounded-3xl flex
                items-center justify-center mb-3 hover:rounded-xl transition-all 
                duration-200 hover:bg-emerald-500 cursor-not-allowed"
        >
          <span className="text-lg font-semibold text-gray-400">
            <PlusCircle className="text-emerald-500 hover:text-white group-hover:text-white" />
          </span>
        </div>
      </div>
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        <div className="px-4 h-16 border-b border-[#202225] flex items-center shadow-sm">
          <div
            className="w-full bg-[#202225] text-sm rounded px-2 h-8 flex
          items-center justify-center text-gray-500 cursor-not-allowed"
          >
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="px-2 mb-4">
            ...
            rounded hover:bg-[#393c43] text-[#dcddde] cursor-not-allowed"
            >
          ...
          <div className="px-2 mb-4">
            <h3 className="text-sm font-semibold text-[#8e9297] px-2 mb-2 uppercase">
              Direct Messages
            </h3>
      ...
      <div className="flex-1 flex flex-col">
        {/* dm header */}
        <div
          className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm
        border-b border-[#202225]"
        >
